                ...
                doc.Page(page =>
                {
                    ...
                    page.Header().ShowOnce().Column(col =>
                    {
                        col.Item().Row(row =>
                        {
                            ...
                            {
                                col.Item().AlignRight().Text("CPI and SPI Analysis Report").FontSize(14).Bold();
                            });
                        });
                    });
                    ...
                    page.Content().PaddingVertical(10).Column(col1 =>
                    {
                        ...
                        col1.Item().Table(table =>
                        {
                            ...
                            table.Header(header =>
                            {
                                ...
                                header.Cell().Background(Colors.White).BorderBottom(0.8f).BorderColor(Colors.Black)
                                    .AlignCenter().AlignBottom().Padding(2).Text("EV").FontColor(secondaryColor).FontSize(8);
                                header.Cell().Background(Colors.White).BorderBottom(0.8f).BorderColor(Colors.Black)
                                    .AlignCenter().AlignBottom().Padding(2).Text("AC").FontColor(secondaryColor).FontSize(8);
                                header.Cell().Background(Colors.White).BorderBottom(0.8f).BorderColor(Colors.Black)
                                    .AlignCenter().AlignBottom().Padding(2).Text("PV").FontColor(secondaryColor).FontSize(8);
                                header.Cell().Background(Colors.White).BorderBottom(0.8f).BorderColor(Colors.Black)
                                    .AlignCenter().AlignBottom().Padding(2).Text("CPI").FontColor(secondaryColor).FontSize(8);
                                header.Cell().Background(Colors.White).BorderBottom(0.8f).BorderColor(Colors.Black)
                                    .AlignCenter().AlignBottom().Padding(2).Text("SPI").FontColor(secondaryColor).FontSize(8);
                                header.Cell().Background(Colors.White).BorderBottom(0.8f).BorderColor(Colors.Black)
                                    .AlignCenter().AlignBottom().Padding(2).Text("EAC").FontColor(secondaryColor).FontSize(8);
                                header.Cell().Background(Colors.White).BorderBottom(0.8f).BorderColor(Colors.Black)
                                    .AlignCenter().AlignBottom().Padding(2).Text("Surplus").FontColor(secondaryColor).FontSize(8);
                                header.Cell().Background(Colors.White).BorderBottom(0.8f).BorderColor(Colors.Black)
                                    .AlignCenter().AlignBottom().Padding(2).Text("%").FontColor(secondaryColor).FontSize(8);
                                header.Cell().Background(Colors.White).BorderBottom(0.8f).BorderColor(Colors.Black)
                                    .AlignCenter().AlignBottom().Padding(2).Text("Analysis").FontColor(secondaryColor).FontSize(8);
                            });
                            ...
                            for (int i = 0; i < projects.Count(); i++)
                            {
                                ...
                                if(project.ProfitInvoicedAnalysis == "Good"){cellBgColor = goodColor;}
                                if(project.ProfitInvoicedAnalysis == "Warning"){cellBgColor = warningColor;}
                                if(project.ProfitInvoicedAnalysis == "Overrruns"){cellBgColor = dangerColor;}
                                ...
                                table.Cell().BorderBottom(0.5f).BorderColor(borderColor).AlignRight().Padding(2).Text(project.ActualCost.ToString("C")).FontSize(8);
                                table.Cell().BorderBottom(0.5f).BorderColor(borderColor).AlignRight().Padding(2).Text(project.CostPerformanceIndexInvoiced.ToString("#.##")).FontSize(8);
                                table.Cell().BorderBottom(0.5f).BorderColor(borderColor).AlignRight().Padding(2).Text(project.SchedulePerformanceIndex.ToString("#.##")).FontSize(8);
                                table.Cell().BorderBottom(0.5f).BorderColor(borderColor).AlignRight().Padding(2).Text(project.EstimateAtCompletionInvoiced.ToString("C")).FontSize(8);
                                table.Cell().BorderBottom(0.5f).BorderColor(borderColor).AlignRight().Padding(2).Text(project.ProfitInvoiced.ToString("C")).FontSize(8);
                                ...
                                table.Cell().Background(cellBgColor).BorderBottom(0.5f).BorderColor(borderColor).AlignCenter().Padding(2).Text(project.ProfitInvoicedAnalysis).FontSize(8);
                            }
                            ...
                            table.Cell().BorderBottom(0.5f).BorderColor(borderColor).AlignRight().Padding(2).Text(projects.Sum(p=>p.PlannedValue).ToString("C")).FontColor(dangerColor).FontSize(7);
                            table.Cell().BorderBottom(0.5f).BorderColor(borderColor).AlignRight().Padding(2).Text(projects.Average(p=>p.CostPerformanceIndexInvoiced).ToString("#.##")).FontColor(dangerColor).FontSize(7);
                            table.Cell().BorderBottom(0.5f).BorderColor(borderColor).AlignRight().Padding(2).Text(projects.Average(p=>p.SchedulePerformanceIndex).ToString("#.##")).FontColor(dangerColor).FontSize(7);
                            table.Cell().BorderBottom(0.5f).BorderColor(borderColor).AlignRight().Padding(2).Text(projects.Sum(p=>p.EstimateAtCompletionInvoiced).ToString("C")).FontColor(dangerColor).FontSize(7);
                            table.Cell().BorderBottom(0.5f).BorderColor(borderColor).AlignRight().Padding(2).Text(projects.Sum(p=>p.ProfitInvoiced).ToString("C")).FontColor(dangerColor).FontSize(7);
